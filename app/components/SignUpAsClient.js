...
export default function SignUpAsClient({clientSignUp,setClientSignUp,setAccess}) {
    ...
    return (
    <div 
        className={clientSignUp ? "w-1/2 max-sm:w-full min-h-screen rounded-3xl flex flex-col justify-start p-4 gap-4": "hidden"}>
