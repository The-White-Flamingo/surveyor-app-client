  ...
  return (
    <div className="flex gap-3 max-sm:flex max-sm:flex-col ">
        <div className="bg-white text-md flex flex-col gap-3 rounded-lg w-56 max-sm:w-full py-3 px-2 mt-5 self-start">
            ...
            <button onClick={()=>showIdentity()} className={`py-1 px-2 hover:bg-gray-100 rounded-md flex items-center gap-2 ${identity ? "bg-gray-100" : "bg-white"}`}><FiUser size={18}/><span>Identity settings</span></button>
