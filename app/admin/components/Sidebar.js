...
export default function Sidebar() {
    ...
    {name:"My Surveys",href:"/admin/surveys",icon: <HiClipboardList size={20}/>},
    {name:"Payments",href:"/admin/payments",icon: <RiWallet3Fill size={20}/>},
    {name:"Messages",href:"/admin/messages",icon: <BiMessageRounded size={20}/>},
    {name:"Help",href:"/admin/help",icon: <AiOutlineQuestionCircle size={20}/>},
    {name:"Account",href:"/admin/account",icon: <FaUserCircle size={20}/>},
    {name:"Disputes",href:"/admin/disputes",icon: <MdReportProblem size={20}/>}
]
